...
def get_status_part_2(string):
    ...
    # positive lookahead assertion that checks for a pair of any two letters that appear at least twice without overlapping
    ...
    if not (bool(re.search(pair_pattern, string)) and bool(re.search(one_between_pattern, string))):
        status = "naughty"
